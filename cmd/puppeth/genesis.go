...
// along with go-. If not, see <http://www.gnu.org/licenses/>.
...
// newCppWabeiGenesisSpec converts a go- genesis block into a Parity specific
// chain specification format.
func newCppWabeiGenesisSpec(network string, genesis *core.Genesis) (*cppWabeiGenesisSpec, error) {
	// Only ethash is currently supported between go- and cpp-
...
// newParityChainSpec converts a go- genesis block into a Parity specific
// chain specification format.
func newParityChainSpec(network string, genesis *core.Genesis, bootnodes []string) (*parityChainSpec, error) {
	// Only ethash is currently supported between go- and Parity
	if genesis.Config.Ethash == nil {
		return nil, errors.New("unsupported consensus engine")
	}
	// Reconstruct the chain spec in Parity's format
...
// newPyWabeiGenesisSpec converts a go- genesis block into a Parity specific
// chain specification format.
func newPyWabeiGenesisSpec(network string, genesis *core.Genesis) (*pyWabeiGenesisSpec, error) {
	// Only ethash is currently supported between go- and py
	if genesis.Config.Ethash == nil {
		return nil, errors.New("unsupported consensus engine")
	}
