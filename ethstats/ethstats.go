...
// Service implements an Wabei netstats reporting daemon that pushes local
// chain statistics up to a monitoring server.
type Service struct {
	server *p2p.Server        // Peer-to-peer server to retrieve networking infos
	eth    *eth.Wabei      // Full Wabei service if monitoring a full node
	les    *les.LightWabei // Light Wabei service if monitoring a light node
...
func New(url string, ethServ *eth.Wabei, lesServ *les.LightWabei) (*Service, error) {
