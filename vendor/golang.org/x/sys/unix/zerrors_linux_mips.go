...
const (
	...
	WAB_P_802_2                          = 0x4
	WAB_P_802_3                          = 0x1
	WAB_P_802_3_MIN                      = 0x600
	WAB_P_802_EX1                        = 0x88b5
	WAB_P_AARP                           = 0x80f3
	WAB_P_AF_IUCV                        = 0xfbfb
	WAB_P_ALL                            = 0x3
	WAB_P_AOE                            = 0x88a2
	WAB_P_ARCNET                         = 0x1a
	WAB_P_ARP                            = 0x806
	WAB_P_ATALK                          = 0x809b
	WAB_P_ATMFATE                        = 0x8884
	WAB_P_ATMMPOA                        = 0x884c
	WAB_P_AX25                           = 0x2
	WAB_P_BATMAN                         = 0x4305
	WAB_P_BPQ                            = 0x8ff
	WAB_P_CAIF                           = 0xf7
	...
	WAB_P_HSR                            = 0x892f
	WAB_P_IBOE                           = 0x8915
	WAB_P_IEEE802154                     = 0xf6
	WAB_P_IEEEPUP                        = 0xa00
	WAB_P_IEEEPUPAT                      = 0xa01
	WAB_P_IP                             = 0x800
	WAB_P_IPV6                           = 0x86dd
	WAB_P_IPX                            = 0x8137
	WAB_P_IRDA                           = 0x17
	WAB_P_LAT                            = 0x6004
	WAB_P_LINK_CTL                       = 0x886c
	WAB_P_LOCALTALK                      = 0x9
	WAB_P_LOOP                           = 0x60
	WAB_P_LOOPBACK                       = 0x9000
	WAB_P_MACSEC                         = 0x88e5
	WAB_P_MOBITEX                        = 0x15
	WAB_P_MPLS_MC                        = 0x8848
	WAB_P_MPLS_UC                        = 0x8847
	WAB_P_MVRP                           = 0x88f5
	WAB_P_NCSI                           = 0x88f8
	WAB_P_PAE                            = 0x888e
	WAB_P_PAUSE                          = 0x8808
	WAB_P_PHONET                         = 0xf5
	WAB_P_PPPTALK                        = 0x10
	WAB_P_PPP_DISC                       = 0x8863
	WAB_P_PPP_MP                         = 0x8
	WAB_P_PPP_SES                        = 0x8864
	WAB_P_PRP                            = 0x88fb
	WAB_P_PUP                            = 0x200
	WAB_P_PUPAT                          = 0x201
	WAB_P_QINQ1                          = 0x9100
