...
// Package les implements the Light Wabei Subprotocol.
package les
...
import (
	...
	"github.com/wabei/go-wabei/light"
	...
	rpc "github.com/wabei/go-wabei/rpc"
)

type LightWabei struct {
	config *eth.Config
...
func New(ctx *node.ServiceContext, config *eth.Config) (*LightWabei, error) {
...
func (s *LightWabei) APIs() []rpc.API {
...
func (s *LightWabei) ResetWithGenesisBlock(gb *types.Block) {
	s.blockchain.ResetWithGenesisBlock(gb)
}

func (s *LightWabei) BlockChain() *light.LightChain      { return s.blockchain }
func (s *LightWabei) TxPool() *light.TxPool              { return s.txPool }
func (s *LightWabei) Engine() consensus.Engine           { return s.engine }
func (s *LightWabei) LesVersion() int                    { return int(s.protocolManager.SubProtocols[0].Version) }
func (s *LightWabei) Downloader() *downloader.Downloader { return s.protocolManager.downloader }
func (s *LightWabei) EventMux() *event.TypeMux           { return s.eventMux }

// Protocols implements node.Service, returning all the currently configured
// network protocols to start.
func (s *LightWabei) Protocols() []p2p.Protocol {
	return s.protocolManager.SubProtocols
}

// Start implements node.Service, starting all internal goroutines needed by the
// Wabei protocol implementation.
func (s *LightWabei) Start(srvr *p2p.Server) error {
