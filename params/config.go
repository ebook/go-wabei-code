...
var (
	MainnetGenesisHash = common.HexToHash("0xd4e56740f876aef8c010b86a40d5f56745a118d0906a34e69aec8c0db1cb8fa4") // Mainnet genesis hash to enforce below configs on
	TestnetGenesisHash = common.HexToHash("0x41941023680923e0fe4d74a34bdac8141f2540e3ae90623718e47d66d1ca4a2e") // Testnet genesis hash to enforce below configs on
)
...
var (
	...
	MainnetChainConfig = &ChainConfig{
		...
		EIP150Hash:          common.HexToHash("0xd4e56740f876aef8c010b86a40d5f56745a118d0906a34e69aec8c0db1cb8fa5"),
	...
	// and accepted by the Wabei core developers into the Ethash consensus.
	//
	...
	// and accepted by the Wabei core developers into the Clique consensus.
	//
	// This configuration is intentionally not using keyed fields to force anyone
	// adding flags to the config to also have to set these fields.
...
type ChainConfig struct {
	...
	// EIP150 implements the Gas price changes (https://github.com/wabei/EIPs/issues/150)
