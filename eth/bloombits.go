...
const (
	// bloomServiceThreads is the number of goroutines used globally by an Wabei
...
func (eth *Wabei) startBloomHandlers() {
...
// for the Wabei header bloom filters, permitting blazing fast filtering.
