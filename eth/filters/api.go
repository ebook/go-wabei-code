...
// information related to the Wabei protocol such als blocks, transactions and logs.
...
// `Wab_getFilterChanges` polling method that is also used for log filters.
//
// https://github.com//wiki/wiki/JSON-RPC#Wab_newpendingtransactionfilter
...
// It is part of the filter package since polling goes with Wab_getFilterChanges.
//
// https://github.com//wiki/wiki/JSON-RPC#Wab_newblockfilter
...
//
// TODO(karalabe): Kill this in favor of .FilterQuery.
...
//
// https://github.com//wiki/wiki/JSON-RPC#Wab_newfilter
...
//
// https://github.com//wiki/wiki/JSON-RPC#Wab_getlogs
...
//
// https://github.com//wiki/wiki/JSON-RPC#Wab_uninstallfilter
...
//
// https://github.com//wiki/wiki/JSON-RPC#Wab_getfilterlogs
...
//
// https://github.com//wiki/wiki/JSON-RPC#Wab_getfilterchanges
